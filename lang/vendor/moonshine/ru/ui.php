...
return [
    ...
    'project' => [
        ...
        'step' => [
            'one_title' => 'Шаг 1',
            'one_text' => 'Для начала создайте в проекте файл с именем .ci-notify.sh и скопируйте в него данный код.',

            'two_title' => 'Шаг 2',
            'two_text' => 'В файле .gitlab-ci.yml найдите нужную стадию и добавьте раздел script, если его нет. Затем в разделе script добавьте строку "sh .ci-notify.sh" в конце строки и передайте аргумент.',

            'three_title' => 'Шаг 3',
            'three_text' => 'На последнем этапе просто отправьте изменения в репозиторий, и вам придет уведомление.',
        ]
    ]
];
